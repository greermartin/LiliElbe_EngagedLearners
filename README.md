...
:----| ------| --------  | -------------  |
*Tues.,* **Sept. 17** | *Intro to Version Control Software* | >> Create GitHub accounts</br> >> Intro to Git/GitHub</br> >> GitHub Scavenger Hunt | **(1)** Read Amin, "Glands, Eugenics, and</br> Rejuvenation in *Man into Woman*" (Sakai)</br></br> **(2)** Upload Amin response to GitHub
